...
export const dashboardBG = "https://res.cloudinary.com/dqxtf297o/image/upload/f_auto,q_auto/v1/artshare-asset/dashboard-feat-example/p5bnmcs6t71k6dbywnim?blur=300&q=1"
...
export const featuresShowcase = [
  ...
  },
  {
    ...
    description: 'Approve automation pushing content to other social platforms.',
  ...
  },
  {
    ...
    description: 'Prepare the ideas for bots to create and upload content row by row',
