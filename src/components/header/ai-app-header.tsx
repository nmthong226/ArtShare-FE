...
const AIHeader = () => {
  ...
  return (
    <nav
      className={`z-50 flex relative justify-between items-center bg-white dark:bg-mountain-950 px-4 border-b-1 border-b-mountain-100 dark:border-b-mountain-700 w-full h-16`}
    >
      <div className="flex items-center h-full">
        ...
        <div className="flex items-center space-x-2">
          <span className="flex font-medium text-lg">Dashboard</span>
