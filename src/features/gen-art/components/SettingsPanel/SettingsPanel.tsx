  ...
  return (
    <div className="absolute flex flex-col w-[300px]">
      ...
      <Accordion
        ...
        className={`flex ${isExpanded ? "" : "hidden"} flex-col m-0 z-10 bg-white shadow-md border border-mountain-300 rounded-xl rounded-t-none w-[300px] ${
          isExpanded ? "max-h-[calc(100vh-9.5rem)]" : "h-fit"
        } overflow-y-auto`}
      >
