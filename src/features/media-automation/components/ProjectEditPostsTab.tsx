  ...
  return (
    <div className="relative flex w-full h-full gap-2 bg-white">
      ...
      <div className="absolute bottom-0 flex space-x-4 -translate-x-1/2 left-1/2">
        ...
        <button
          type="submit"
          className="flex items-center justify-center w-48 px-6 py-2 mt-4 transition rounded-md cursor-pointer bg-mountain-200 hover:bg-mountain-300/80 text-mountain-950 btn"
        >
          Next Step
        </button>
      </div>
